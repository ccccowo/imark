...
export default function ResultDetailPage({ 
    ...
    params: { examId: string; resultId: string } 
}) {
    ...
    const [activeQuestion, setActiveQuestion] = useState<string>(''); // 当前激活的题目ID
    ...
    const fetchDetail = async () => {
        try {
            ...
            const response = await axiosInstance.get(
                `/api/exams/${params.examId}/results/${params.resultId}/detail`
            );
    ...
    return (
        <div className="p-6 space-y-4">
            ...
            {/* 快速导航 */}
            <Card className="shadow-md sticky top-4 z-10 bg-white">
